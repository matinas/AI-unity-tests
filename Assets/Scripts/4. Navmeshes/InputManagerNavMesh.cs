...
{
    public class InputManagerNavMesh : MonoBehaviour
    {
        private static InputManagerNavMesh _instance;

        public static InputManagerNavMesh Instance
        {
            get
            {
                if (_instance == null)
        ...
        void Update()
        {
            if (Input.GetMouseButtonDown(0))
            {
                ...
                PathfindingManagerNavMesh.Instance.SetWPColliders(true);
                ...
                PathfindingManagerNavMesh.Instance.SetWPColliders(false);
            }
        }
    }
}
